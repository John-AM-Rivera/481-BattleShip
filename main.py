...
def main():
    ...
    parser.add_argument("-p1",type=str,nargs=2,default=("SearchHuntStrategy","randomplacement"), metavar=("P1_STRAT","P1_PLACEMENT"),help="player 1: name of shooting strategy and name of placement strategy")
